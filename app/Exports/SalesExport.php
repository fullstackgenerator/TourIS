...
class SalesExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($sale): array
    {
        return [
            ...
            Carbon::parse($sale->departure_airport_trip_A_date)->format('d. m. Y'),
            $sale->arrival_airport_trip_A,
            Carbon::parse($sale->arrival_airport_trip_A_date)->format('d. m. Y'),
            $sale->departure_airport_trip_B,
            Carbon::parse($sale->departure_airport_trip_B_date)->format('d. m. Y'),
            $sale->arrival_airport_trip_B,
            Carbon::parse($sale->arrival_airport_trip_B_date)->format('d. m. Y'),
